...
describe("renderTemplate", () => {
  ...
  it("renders {{#if condition}}...{{/if}} when variable is truthy", () => {
    const template =
      "Event occurred.{{#if description}} Details: {{description}}{{/if}}";
    const result = renderTemplate(template, {
  ...
  it("removes {{#if condition}}...{{/if}} when variable is missing", () => {
    const template =
      "Event occurred.{{#if description}} Details: {{description}}{{/if}} End.";
    const result = renderTemplate(template, {});
  ...
  describe("sendTestNotificationSchema", () => {
    it("accepts a valid payload", () => {
      const result = sendTestNotificationSchema.safeParse({
        templateId: "11111111-1111-4111-a111-111111111111",
        channel: "email",

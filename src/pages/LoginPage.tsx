    ...
    <div className="flex min-h-screen items-center justify-center bg-background p-4">
      <div className="w-full max-w-sm">
        <div className="flex flex-col items-center mb-8">
          <div className="flex items-center justify-center w-14 h-14 rounded-2xl bg-primary text-primary-foreground font-bold text-xl mb-4">
            AV
          </div>
          <h1 className="text-2xl font-bold">AION Vision Hub</h1>
          <p className="text-sm text-muted-foreground mt-1">Unified Video Surveillance Platform</p>
        </div>
              ...
              <TabsContent value="login" className="mt-0">
                <form onSubmit={handleLogin} className="space-y-4">
                  ...
                  <div className="relative my-2">
                    <Separator />
                    <span className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 bg-card px-2 text-[10px] text-muted-foreground">or</span>
                  </div>
        ...
        <div className="mt-3 flex items-center gap-2 text-xs text-muted-foreground justify-center">
          ...
          <span>Secured with Lovable Cloud</span>
        </div>
      </div>
    </div>
  );

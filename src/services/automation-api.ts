...
export const automationRulesApi = {
  list: (filters?: { isActive?: string; triggerType?: string; page?: number; perPage?: number }) =>
    apiClient.get<{ success: boolean; data: any[]; meta: any }>('/automation/rules', filters as Record<string, string | number | boolean | undefined>),

  get: (id: string) =>
    apiClient.get<{ success: boolean; data: any }>(`/automation/rules/${id}`),

  create: (rule: Record<string, unknown>) =>
    apiClient.post<{ success: boolean; data: any }>('/automation/rules', rule),

  update: (id: string, updates: Record<string, unknown>) =>
    apiClient.patch<{ success: boolean; data: any }>(`/automation/rules/${id}`, updates),
...
export const automationExecutionsApi = {
  list: (filters?: { ruleId?: string; status?: string; page?: number; perPage?: number }) =>
    apiClient.get<{ success: boolean; data: any[]; meta: any }>('/automation/executions', filters as Record<string, string | number | boolean | undefined>),
};
